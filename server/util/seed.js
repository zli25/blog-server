...
var users = [
  {username: 'Jimmylo', password: 'test1234'},
  {username: 'Xoko', password: 'test2345'},
  {username: 'katamon', password: 'test345678'}
];
...
var posts = [
  {title: 'Learn angular 2 today', content: 'Angular to is so dope'},
  {title: '10 reasons you should love IE7', content: 'IE7 is so amazing'},
  {title: 'Why we switched to Go', content: 'go is dope'}
];
